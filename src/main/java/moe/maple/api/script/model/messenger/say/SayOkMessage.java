 ...
 * Created on 9/4/2019.
 */
public class SayOkMessage extends SayMessage {
    public SayOkMessage(int speakerType, int speakerTemplate, int replaceTemplate, int parameters, String message) {
    ...
    public void onMessage(SayMessenger messenger, UserObject userObject, boolean prev, boolean next) {
        super.onMessage(messenger, userObject, prev, false);
    }
}
